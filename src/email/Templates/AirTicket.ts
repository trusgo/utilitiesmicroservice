...
export class AirTicket {
  ...
  Template = (data) => {
    ...
    <img src="https://lh3.googleusercontent.com/gctSEqudBf9HVKxAdmmS3Dtacy8H5QG-m80szVfvdeDaYE8Y0X3H4jyWLF8eq0E5xZV5=s128" style="margin:0;border:0;padding:0;display:block;width:95px;height:43px" align="left" width="95" height="43" class="CToWUd">
    </td>
    ...
    <tr>
    <td valign="top" style="width:15px">&nbsp;</td>
    <td valign="top" align="left" style="width:265px;margin:0;padding:0;font-family:Arial,Helvetica,sans-serif;color:#ffffff;font-weight:normal;line-height:100%;text-align:left;font-size:10px;letter-spacing:0;background-color:#00bfff"></td>
    </tr>
    <tr>
    ...
    <tr>
    <td valign="top" style="width:15px">&nbsp;</td>
    <td valign="top" align="left" style="width:265px;margin:0;padding:0;font-family:Arial,Helvetica,sans-serif;color:#ffffff;font-weight:bold;line-height:100%;text-align:left;font-size:12px;letter-spacing:1;background-color:#00bfff">  PNR: ${PNR}</td>
    </tr>
    <tr>
    <td colspan="2" height="1" style="line-height:1px;font-size:1px;height:1px">&nbsp;</td>
    </tr>
    ...
    <tbody>
    <tr>
    <td valign="top" align="left" style="margin:0;padding:0;font-family:Arial,Helvetica,sans-serif;color:#000000;font-weight:bold;line-height:100%;text-align:left;font-size:11px;letter-spacing:0">${Source}</td>
    <td valign="top" style="width:15px">&nbsp;</td>
    </tr>
    <tr>
    <td colspan="2" height="1" style="line-height:1px;font-size:1px;height:1px">&nbsp;</td>
    ...
    <tr>
    <td valign="top" align="left" style="margin:0;padding:0;font-family:Arial,Helvetica,sans-serif;color:#000000;font-weight:normal;line-height:100%;text-align:left;font-size:11px;letter-spacing:0">${DepatureDate} &nbsp;${DepatureTime} Hrs  </td>
    <td valign="top" style="width:15px">&nbsp;</td>
    </tr>
    </tbody>
    </table>
    ...
    <table valign="middle" align="center" style="width:136px" cellpadding="0" cellspacing="0"><tbody><tr><td valign="top" align="center" style="margin:0;padding:0;font-family:Arial,Helvetica,sans-serif;color:#000000;font-weight:bold;line-height:100%;text-align:center;font-size:11px;letter-spacing:0">${Flight}</td>
    </tr>
    <tr>
    ...
    <tbody>
    <tr>
    <td valign="top" align="right" style="margin:0;padding:0;font-family:Arial,Helvetica,sans-serif;color:#000000;font-weight:bold;line-height:100%;text-align:right;font-size:11px;letter-spacing:0">${Destination} </td>
    <td valign="top" style="width:15px">&nbsp;</td>
    </tr>
    <tr>
    <td colspan="2" height="1" style="line-height:1px;font-size:1px;height:1px">&nbsp;</td>
    ...
    <tr>
    <td valign="top" align="right" style="margin:0;padding:0;font-family:Arial,Helvetica,sans-serif;color:#000000;font-weight:normal;line-height:100%;text-align:right;font-size:11px;letter-spacing:0">${ArrivalDate}&nbsp;${ArrivalTime} Hrs </td>
    <td valign="top" style="width:15px">&nbsp;</td>
    </tr>
    </tbody>
    </table>
    ...
    <tbody>
    <tr>
    <td style="font-family:Arial,Helvetica,sans-serif;color:#ffffff;font-weight:bold;line-height:100%;text-align:left;font-size:11px;letter-spacing:0px;background-color:#333333;padding-left:10px;padding-top:8px;padding-bottom:8px;border-right:1px solid #cccbcb;border-top:1px solid #333333;border-left:1px solid #333333;border-top-left-radius:10px;padding-right:5px;width:100px">Passenger Name</td>
