...
export class RegisterTemplate {
  Template = (data) => {
    ...
    return `
   <div>
    <img style="width:40px; height: 40px; position: absolute" alt="qtrip logo" src="https://lh3.googleusercontent.com/gctSEqudBf9HVKxAdmmS3Dtacy8H5QG-m80szVfvdeDaYE8Y0X3H4jyWLF8eq0E5xZV5=s128"/><br/>
